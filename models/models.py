...
class DecoderOnlyTransformer(nn.Module):
    ...
    def setup(self):
        ...
        self.blocks = [DecoderBlock(d_model=self.d_model, n_heads=self.n_heads, mlp_ratio=self.mlp_ratio, dropout_rate=self.dropout_rate) for _ in range(self.n_layers)]
